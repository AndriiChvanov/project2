...
/* harmony import */ var _modules_changeCalc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/changeCalc */ "./src/js/modules/changeCalc.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_changeCalc__WEBPACK_IMPORTED_MODULE_7__["default"])(modalState);
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function changeParam(event, elem) {
    elem.addEventListener(event, function (e) {
      ...
      var calcFunc = function calcFunc(state) {
...
var changeCalc = function changeCalc(state) {
  var sizeSelect = document.querySelectorAll('#size'),
...
/* harmony default export */ __webpack_exports__["default"] = (changeCalc);
